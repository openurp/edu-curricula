...
[#--    bar.addItem("${b.text("action.delete")}",action.remove("确认删除?"));--]
    bar.addItem("${b.text("action.export")}",action.exportData("course.code:课程代码,course.name:课程名称,department.name:开课院系,course.credits:学分,course.creditHours:学时,author.name:负责人,teachers:授课教师",null,
  ...
  [@b.row]
    ...
    [@b.col width="25%" property="department.name" title="开课院系"/]
