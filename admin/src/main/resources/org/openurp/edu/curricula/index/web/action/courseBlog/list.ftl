...
[@b.grid  items=courseBlogs var="courseBlog" ]
  ...
  [@b.row]
    ...
    [@b.col width="13%" property="updatedAt" title="最新修改时间"]${courseBlog.updatedAt?string("yyyy-MM-dd HH:mm")!}[/@]
    [@b.col width="10%" property="status" title="审核状态"]${(courseBlog.status.name)!}[/@]
    [@b.col width="7%" property="auditor.name" title="审核人"/]
    [@b.col width="13%" property="auditAt" title="审核时间"]${(courseBlog.auditAt?string("yyyy-MM-dd HH:mm"))!}[/@]
  [/@]
[/@]
[@b.foot/]